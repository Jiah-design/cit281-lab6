...
const worldTravel = new Book("World Travel", "Anthony Bourdain", "04/20/2021")
const deepWork = new Book("Deep Work", "cal Newport", "01/01/2016")
*/
...
library.addBook(atomicHabits);
library.addBook(worldTravel);
library.addBook(deepWork);
console.log(`Book count: ${library.count}`);
library.listBooks();
*/